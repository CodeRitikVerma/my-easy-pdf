...
const nextConfig: NextConfig = {
  ...
  async redirects() {
    return [
      ...
      // Additional common misspellings / alternate slugs
      { source: '/convert-jpg-to-pdf', destination: '/jpg-to-pdf',   permanent: true },
      { source: '/convert-pdf-to-jpg', destination: '/pdf-to-jpg',   permanent: true },
      { source: '/images-to-pdf',      destination: '/image-to-pdf', permanent: true },
      ...
      { source: '/rotate-pdfs',        destination: '/rotate-pdf',   permanent: true },
    ];
  },
