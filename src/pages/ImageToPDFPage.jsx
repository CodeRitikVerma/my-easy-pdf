    ...
    try {
      ...
      for (const imgData of images) {
        ...
        if (imgData.file.type === 'image/jpeg' || imgData.file.type === 'image/jpg') {
          ...
          // Convert unsupported formats (WebP, GIF, etc.) to PNG via canvas
          const img = new Image();
          const blobUrl = URL.createObjectURL(imgData.file);
  ...
  return (
    <>
      <SEO
        ...
        description="Convert JPG, PNG, WebP, and GIF images to PDF online for free. Set page size, orientation, and margins. No upload required — works entirely in your browser."
        keywords="image to PDF, JPG to PDF, PNG to PDF, convert image to PDF online free, photo to PDF"
      />
      <div className="page-header text-center">
        <Container>
          <h1 className="fw-bold mb-2">
            <i className="bi bi-images me-2"></i>Image to PDF
          </h1>
          ...
          <>
            <div className="mt-4 mb-3 d-flex justify-content-between align-items-center">
              <h5 className="fw-bold mb-0">
                Images <Badge bg="primary" pill>{images.length}</Badge>
              ...
              {images.map((img, index) => (
                ...
                >
                  ...
                  <div className="d-flex flex-column gap-1 me-2 flex-shrink-0">
                    ...
                    <button className="btn-reorder" onClick={() => moveDown(index)} disabled={index === images.length - 1} title="Move down">
            ...
            <div className="text-center">
              ...
              >
                {isProcessing
                  ...
                  : <><i className="bi bi-file-earmark-arrow-down me-2"></i>Convert &amp; Download PDF</>
                }
              </Button>
            </div>
          </>
