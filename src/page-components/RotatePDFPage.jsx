  ...
  const handleFiles = async (files) => {
    ...
    try {
      ...
      for (let i = 1; i <= pdf.numPages; i++) {
        ...
        pageData.push({ index: i, thumbnail, rotation: 0, selected: false });
      }
      setPages(pageData);
    } catch (err) {
  ...
  return (
    <>
      <SEO
        ...
        description="Rotate one, some, or all pages of a PDF by 90° or 180° online for free. Select specific pages to rotate. No upload required — 100% browser-based."
        keywords="rotate PDF, rotate PDF pages online, flip PDF pages, PDF rotation tool free"
      />
      <div className="page-header text-center">
        <Container>
          <h1 className="fw-bold mb-2">
            <i className="bi bi-arrow-clockwise me-2"></i>Rotate PDF
          </h1>
            ...
            <div className="settings-panel mb-4">
              <Row className="g-2 align-items-center flex-wrap">
                ...
                {selectedCount > 0 && (
                  <>
                    <Col xs="auto">
                      <span className="text-muted small">Rotate selected ({selectedCount}):</span>
                    </Col>
                    <Col xs="auto">
                      <ButtonGroup size="sm">
                        <Button variant="outline-primary" onClick={() => rotate(-90, 'selected')}>
                          <i className="bi bi-arrow-counterclockwise"></i> 90°
                        </Button>
                        <Button variant="outline-primary" onClick={() => rotate(90, 'selected')}>
                          <i className="bi bi-arrow-clockwise"></i> 90°
                        </Button>
                        <Button variant="outline-primary" onClick={() => rotate(180, 'selected')}>
                          180°
                        </Button>
                      </ButtonGroup>
                    </Col>
                ...
                <Col xs="auto" className="ms-auto">
                  ...
                  <ButtonGroup size="sm">
                    <Button variant="primary" onClick={() => rotate(-90, 'all')}>
                      <i className="bi bi-arrow-counterclockwise"></i> 90°
                    </Button>
                    <Button variant="primary" onClick={() => rotate(90, 'all')}>
                      <i className="bi bi-arrow-clockwise"></i> 90°
                    </Button>
                    <Button variant="primary" onClick={() => rotate(180, 'all')}>
                      180°
                    </Button>
                  </ButtonGroup>
                </Col>
                    ...
                    <div className="text-center" style={{ minHeight: 22 }}>
                      {page.rotation !== 0 && (
                        <Badge bg="warning" text="dark" pill className="me-1">
                          <i className="bi bi-arrow-clockwise me-1"></i>{page.rotation}°
                        </Badge>
                      )}
                      {page.selected && (
            ...
            <div className="text-center">
              ...
              >
                {isProcessing
                  ...
                  : <><i className="bi bi-file-earmark-arrow-down me-2"></i>Apply Rotation &amp; Download</>
                }
              </Button>
              {!hasRotations && (
                <p className="text-muted small mt-2">Rotate at least one page to enable download.</p>
              )}
            </div>
          </>
        )}
