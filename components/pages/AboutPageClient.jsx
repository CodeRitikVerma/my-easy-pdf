...
const values = [
  { icon: 'bi-shield-lock-fill',      color: palette.values.privacy, title: 'Privacy First',     text: "Every file stays on your device. Nothing is ever sent to a server. We don't store, read, or transmit your documents." },
  { icon: 'bi-gift-fill',             color: palette.values.free,    title: 'Always Free',       text: 'No subscriptions, no paywalls, no watermarks. Every tool is completely free — today and forever.' },
  { icon: 'bi-lightning-charge-fill', color: palette.values.speed,   title: 'Instant & Offline', text: "All processing happens locally in your browser. Works fast, even without an internet connection." },
  { icon: 'bi-code-slash',            color: palette.values.craft,   title: 'Built with Care',   text: "Crafted by a developer who values clean tools, great UX, and respecting the user's time and data." },
];
      ...
      <Container className="py-4 py-md-5" style={{ maxWidth: 860 }}>
              ...
              <Row className="g-4 align-items-center">
                ...
                <Col>
                  ...
                  <a href="mailto:ritikverma210@gmail.com"
                    className="btn btn-sm px-3" style={{ background: palette.gradient.primary, color: 'white', border: 'none' }}>
        ...
        <section>
          ...
          <Row className="g-3">
            {tools.map((t, i) => (
              <Col key={i} xs={6} md={4}>
                <Link href={t.href} className="d-flex align-items-center gap-3 p-3 rounded-3 text-decoration-none border" style={{ transition: 'background .15s' }}
