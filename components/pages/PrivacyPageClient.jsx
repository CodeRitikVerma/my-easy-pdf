    ...
    <>
      ...
      <Container className="py-4 py-md-5" style={{ maxWidth: 760 }}>
        ...
        <Section title="1. Overview">
          ...
          is transmitted to any external server operated by us.
        </Section>
        ...
        <Section title="5. Third-Party Services">
          MyEasyPDF may load static icon and font assets from a third-party CDN for performance purposes.
          These are static asset requests only — no personal data or file contents are shared.
        </Section>
        ...
        <Section title="8. Contact">
          Questions? Reach the developer by email:{' '}
