    ...
    <>
      <div className="page-header text-center">
        <Container>
          ...
          <p className="lead opacity-90 mb-0">Reorder pages using the arrow buttons, then save your PDF</p>
        </Container>
      </div>
        ...
        {pages.length > 0 && (
          <>
            <p className="text-muted small mb-3">
              Use the arrow buttons to reorder pages. The number shown is the new position in the output PDF.
            </p>
                  ...
                  <div style={{
                    ...
                    <div className="text-center mt-1 small fw-semibold" style={{ color: palette.text.secondary }}>
                      ...
                      {page.originalIndex !== pos + 1 && (
                        <span className="ms-1" style={{ color: palette.indigo[500], fontSize: '0.75em' }}>
