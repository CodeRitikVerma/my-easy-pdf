    ...
    <>
      ...
      <div
        ...
        <div style={{ flexShrink: 0, display: 'flex', alignItems: 'center', justifyContent: 'space-between', padding: compact ? '12px 16px' : '16px 28px 14px', borderBottom: `1px solid ${palette.border.default}`, background: palette.surface.base, boxShadow: '0 2px 8px rgba(15,23,42,0.06)' }}>
          ...
          <button onClick={onClose} style={{ width: 36, height: 36, borderRadius: '50%', border: `1px solid ${palette.border.strong}`, background: 'transparent', color: palette.text.muted, cursor: 'pointer', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: '0.9rem', flexShrink: 0 }}
